...
Pod::Spec.new do |s|
  ...
  s.source_files = "ios/Capacitor/Capacitor/*.{swift,h,m}", "ios/Capacitor/Capacitor/Plugins/*.{swift,h,m}",
                   "ios/Capacitor/Capacitor/Plugins/**/*.{swift,h,m}"
  s.module_map = "ios/Capacitor/Capacitor/Capacitor.modulemap"
  s.resources = ["ios/Capacitor/Capacitor/assets/native-bridge.js", "ios/Capacitor/Capacitor/PrivacyInfo.xcprivacy"]
